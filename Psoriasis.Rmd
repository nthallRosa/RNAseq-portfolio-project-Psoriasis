...
if (require("knitr")) {
  message("knitr is already installed.")
} else {
  message("knitr needs to be installed. Installing now...")
...
```{r PCA plot, fig.align='center', message=FALSE, fig.cap = "Figure 1. Principal component analysis plot examining the groupings of samples by disease state."}
...
```{r MA plot, fig.align='center', fig.cap="Figure 2. MA plot examining the mean average of log-transformed normalized gene counts. Log-fold change thresholds are set to -2 and 2."}
plotMA(dds)
...
### Volcano plot
```{r volcano plot, message=FALSE, warning=FALSE, fig.height=6, fig.width=6, fig.align='center', fig.cap="Figure 3. Volcano plot displaying the top over expressed and suppressed genes in Psoriasis patients compared to normal patients. Log-fold change thresholds of -1 and 1 were used with an adjusted p value of 0.05."}
...
```{r top 20 enriched biological processes, message=FALSE,warning=FALSE,fig.height=12, fig.width=9, fig.cap="Figure 4. Bar plot displaying the top 20 biological processes enriched in psoriasis patients vs normal patients. Count refers to the number of genes that contribute to each process."}
...
```{r dotplot of top 18 activated pathways, fig.height=6, fig.width=6, fig.cap="Figure 5. Dot plot displaying the top 18 activated pathways in psoriasis patients vs normal patients. Size of the dots refer to number of genes associated with each pathway, while the GeneRatio refers the proportion of genes in the pathway compared to the total number of genes analyzed."}
...
```{r dotplot of top 18 suppressed pathways, fig.height=6, fig.width=6, fig.cap="Figure 6.Dot plot displaying the top 18 suppressed pathways in psoriasis patients vs normal patients. Size of the dots refer to number of genes associated with each pathway, while the GeneRatio refers the proportion of genes in the pathway compared to the total number of genes analyzed."}
...
```{r kegg plot for Th17 differentiation, message=FALSE, fig.align='center',dpi = 100,out.width="80%", out.height="60%", fig.cap="Figure 7. KEGG pathway for Th17 cell differentiation."}
...
```{r kegg plot for rheumatoid arthritis, message=FALSE, fig.align='center', dpi = 100,out.width="80%", out.height="60%", fig.cap="Figure 8. KEGG pathway for Rheumatoid arthritis."}
...
```{r venn diagram, fig.align='center',fig.height=4, fig.width=4, fig.cap="Figure 9.Venn Diagram displaying the number of genes shared and unique to the Th17 pathway and the rheumatoid pathway."}
